...
\begin{proof}
	...
	% TODO: I've added in a few sentences explaining the proof. Thoughts?
	...
	\begin{enumerate}[label=\roman*.]
		...
		\end{equation}
		% TODO: perhaps fix the notation of buckets to make it more clear that sigma is the guess vector.
		...
		% TODO: justify this statement XP
	...
	% TODO: define black hits pls, to justify this
	Combining this with (\ref{color-buck}), we have
	\begin{equation*}
	\sum_{j \neq \sigma_1} |D_i(j,B_t(s))| = |B(0)|.
	\end{equation*}
	%TODO: might want to use a different thing instead of j, idk.
...
\begin{proof}
	By iterating \ref{thm1},  %TODO: fix this reference
...
%TODO: talk about the with-repeats game, talk about corollaries/asymptotics.
