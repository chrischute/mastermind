...
\section*{Lower Bound for Non-Adaptive Strategies: $n=k$}
	...
	For sufficiently large $n$,
		\begin{equation*}
		\frac{n\log n}{(\log\log n)^c} < \frac{n\log n}{4} <\frac{n(\log n - 1)}{2}
		\end{equation*}
	$\Longrightarrow$
		\begin{align*}
	...
	$\Longrightarrow$
		\begin{align*}
		\lim_{n\rightarrow\infty}\frac{\log(n!)}{\log(x^t)}
		& \ge 2
		\end{align*}
	$\Longrightarrow$
		\begin{align*}
		\lim_{n\rightarrow\infty}\frac{n!}{x^t}
		& \ge \lim_{n\rightarrow\infty}\frac{n!}{\sqrt{n!}}\\
	...
	$\Longrightarrow$
		\begin{align*}
		\lim_{n\rightarrow\infty}\frac{\log t}{\log x^t} \le 2
		\end{align*}
	$\Longrightarrow$
		\begin{align*}
		\lim_{n\rightarrow\infty}\frac{t}{x!}
		& \le \lim_{n\rightarrow\infty}\frac{t}{t^2}\\
		& = 0
		\end{align*}
	Therefore
		\begin{equation*}
		\lim_{n\rightarrow\infty}\left(1-\frac{t}{x!}\right) = 1\qquad\text{and}\qquad
		\lim_{n\rightarrow\infty}\frac{n!}{x^t}\left(1-\frac{t}{x!}\right) = \infty
		\end{equation*}
	So for sufficiently large $n$,
		\begin{equation*}
		n!\left(1-\frac{t}{x!}\right) > x^t \Longrightarrow N_t>k_t
		\end{equation*}
	
	Therefore, for all $\epsilon$ and for sufficiently large $n$, we have a lower bound
	of
		\begin{equation*}
